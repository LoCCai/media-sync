...
## Latest: login runtime omissions and diagnostics (2026-09-05)
...
| Live login (any platform) | Historical failed Bilibili/Douyin/XHS sessions observed; repaired revision not yet live-tested. No platform PASS | [Failure evidence](executions/0055-operator-auth-playback-evidence/secure-console/login-runtime-triage.md); execution 0047 remains the canary gate |
