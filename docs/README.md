...
| 0006 | Durable scheduler and throttled workers / 持久调度与限流工作器 | Complete for the offline/Fake scope; live rows remain `NOT_RUN` / 离线/Fake 范围完成；真人行保持 `NOT_RUN` | Plan `c8c4e54`; this bilingual closeout commit / 计划 `c8c4e54`；本次双语收尾提交 |
